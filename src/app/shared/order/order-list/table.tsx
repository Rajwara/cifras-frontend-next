...
import { getColumns } from '@/app/shared/order/order-list/columns';
import { ActionIcon } from 'rizzui';
import cn from '@/utils/class-names';
import ExpandedOrderRow from '@/app/shared/order/order-list/expanded-row';
// dynamic import
const FilterElement = dynamic(
  () => import('@/app/shared/order/order-list/filter-element'),
  { ssr: false }
);
