...
import CustomFields from '@/app/shared/clients/create-edit/custom-fields';
...
export default function ProductIdentifiers({
  ...
  return (
    <FormGroup
      title="Clients Identifiers"
      description="Edit your Clients identifiers here"
