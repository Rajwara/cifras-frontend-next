...
import CustomFields from '@/app/shared/quotes/create-edit/custom-fields';
...
export default function ProductIdentifiers({
  ...
  return (
    <FormGroup
      title="quotes Identifiers"
      description="Edit your quote identifiers here"
