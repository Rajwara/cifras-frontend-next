...
import GetSize from '@/app/shared/inventory/get-size';
import { calculatePercentage } from '@/utils/calculate-percentage';
import { GetColor } from '@/app/shared/inventory/get-color';
import WishlistButton from '@/app/shared/inventory/wishlist-button';
...
export default function ProductDetailsSummery({
  ...
  const onSubmit: SubmitHandler<ProductDetailsInput> = (data) => {
    ...
    setTimeout(() => {
      ...
      toast.success(<Text as="b">inventory added to the cart</Text>);
    }, 600);
  };
