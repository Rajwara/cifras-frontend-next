...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="inventory" />,
    dataIndex: 'itemname',
    key: 'itemname',
    width: 300,
    hidden: 'customer',
    ...
    render: (_: string, row: ProductType) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.inventory.ediInventory(row.id)}>
            <ActionIcon size="sm" variant="outline" aria-label={'Edit inventory'}>
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.inventory.inventoryDetails(row.id)}>
            <ActionIcon size="sm" variant="outline" aria-label={'View inventory'}>
        ...
        <DeletePopover
          ...
          description={`Are you sure you want to delete this #${row.id} inventory?`}
