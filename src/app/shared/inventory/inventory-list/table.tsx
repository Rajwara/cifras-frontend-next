...
import { getColumns } from '@/app/shared/inventory/inventory-list/columns';
const FilterElement = dynamic(
  () => import('@/app/shared/inventory/inventory-list/filter-element'),
  { ssr: false }
);
        ...
        tableFooter={
          ...
          >
            <Button size="sm" className="dark:bg-gray-300 dark:text-gray-800">
              ...
              {selectedRowKeys.length > 1 ? 'Inventory' : 'Inventory'}
            </Button>
          </TableFooter>
        }
