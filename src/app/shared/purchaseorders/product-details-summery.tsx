...
import GetSize from '@/app/shared/purchaseorders/get-size';
import { calculatePercentage } from '@/utils/calculate-percentage';
import { GetColor } from '@/app/shared/purchaseorders/get-color';
import WishlistButton from '@/app/shared/purchaseorders/wishlist-button';
...
export default function ProductDetailsSummery({
  ...
  const onSubmit: SubmitHandler<ProductDetailsInput> = (data) => {
    ...
    setTimeout(() => {
      ...
      toast.success(<Text as="b">Purchase Orders added to the cart</Text>);
    }, 600);
  };
