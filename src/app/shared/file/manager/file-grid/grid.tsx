      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex">
          ...
          <Popover placement="left">
            ...
            <Popover.Content className="z-0 min-w-[140px] px-0 dark:bg-gray-100 [&>svg]:dark:fill-gray-100">
              {({ setOpen }) => (
                <div className="px-2 text-gray-900">
                  <Button
                    variant="text"
                    onClick={() => setOpen(false)}
                    className="group flex w-full items-center justify-start px-2 py-2.5 hover:bg-gray-100 focus:outline-none dark:hover:bg-gray-50"
                  >
