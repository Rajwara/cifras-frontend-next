...
import { VendorType } from '@/data/vendor-data';
    ...
    render: (_: string, row: VendorType) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.vendor.editVendor(row.id)}>
            <ActionIcon size="sm" variant="outline" aria-label={'Edit Vendor'}>
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.vendor.vendorDetails(row.id)}>
            <ActionIcon size="sm" variant="outline" aria-label={'View Vendor'}>
        ...
        <DeletePopover
          ...
          description={`Are you sure you want to delete this #${row.id} vendor?`}
