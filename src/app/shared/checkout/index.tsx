...
import DifferentBillingAddress from '@/app/shared/order/order-form/different-billing-address';
import { orderData } from '@/app/shared/order/order-form/form-utils';
import AddressInfo from '@/app/shared/order/order-form/address-info';
import ShippingMethod from '@/app/shared/checkout/shipping-method';
import PaymentMethod from '@/app/shared/checkout/payment-method';
import OrderSummery from '@/app/shared/checkout/order-summery';
import OrderNote from '@/app/shared/checkout/order-note';
...
export default function CheckoutPageWrapper({
  ...
  const onSubmit: SubmitHandler<CreateOrderInput> = (data) => {
    ...
    setTimeout(() => {
      ...
      router.push(routes.order.orderDetails(DUMMY_ID));
