...
import { permissions, report } from '@/app/shared/report-permissions/utils';
...
} from '@/utils/validators/edit-reprot.schema';

export default function EditReport() {
  const { closeModal } = useModal();
  const [isLoading, setLoading] = useState(false);

  const onSubmit: SubmitHandler<ReportPermissionInput> = (data) => {
  ...
  return (
    <Form<ReportPermissionInput>
      onSubmit={onSubmit}
      validationSchema={reportPermissionSchema}
      useFormProps={{
        defaultValues: {
