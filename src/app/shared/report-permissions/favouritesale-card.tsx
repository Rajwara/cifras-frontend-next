...
import EditReport from '@/app/shared/report-permissions/edit-report';
import CreateUser from '@/app/shared/report-permissions/create-user';
import Favourite from '../../../../public/favourite.svg'
type User = {
  
  id: number;
  report: keyof typeof FAVOURITESALE;
  avatar: string;
};

interface FavouritesaleCardProps {
  name: string;
  color?: string;
  className?: string;
...
export default function FavouritesaleCard({
  name,
  color,
  users,
  className,
}: FavouritesaleCardProps) {
     ...
     <header className="flex items-center justify-between gap-2">
       <div className="flex items-center gap-3">
        ...
        <Title as="h4" className="font-medium">
         ...
         <p>2.4 GB . 135 files</p>
        </div>
       </div>
<div className='justify-end align-bottom items-end relative'>
<Image src={Favourite} alt='' className='justify-end align-bottom items-end ml-2' />
