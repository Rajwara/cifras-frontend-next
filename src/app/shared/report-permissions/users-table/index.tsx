...
import { getColumns } from '@/app/shared/report-permissions/users-table/columns';
import Detailsandhistorytabs from '../../detailsandhistorytabs/detailsandhistorytabs';
import ReportGallery from '../../../shared/reports/reportgallery';
const FilterElement = dynamic(
  () => import('@/app/shared/report-permissions/users-table/filter-element'),
  { ssr: false }
);
