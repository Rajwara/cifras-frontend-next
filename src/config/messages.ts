export const messages = {
  ...
  reportNameIsRequired: 'Report Name is Required',
  reportNameLengthMin: 'Report name must be at least 3 letters',
  errorSendingEmail: 'Error sending email',
  emailSentSuccessfully: 'Your email has been sent successfully.',
  itemnumberRequired:"Item Number is Required",
  ...
  rucRequired:"RUC is Required",
  dvRequired:"Dv is Required",
  ponumberRequired:"Purchase Order is Required",
  dateofpurchasingRequired:"Date is Required",
  statusRequired:"Status is Required",
  subtotalRequired:"Sub Total is Required",
  taxRequired:"Tax is Required",
  totalRequired:"Total is Required",
  shippingRequired:"Shipping is Required",
  onhandqtyRequired:"On hand Qty is Required",
  incomingqtyRequired:"Incoming Qty is Required",
  reservedqtyRequired:"Reserved Qty is Required",
  quoteNumberRequired:" Quote Number is Required",
  quoteDateRequired : "Quote Date is Required",
  notificationDateRequired: "Notification Date is Required",
